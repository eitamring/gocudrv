...
copies, memory pool access, non-blocking stream polling, occupancy helpers,
device global access, CUDA graph capture and replay, stream-ordered async allocation,
